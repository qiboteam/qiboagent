...
st.markdown("""
Welcome to the AI assistant for **Qibo** — the open-source Python framework for quantum computing.
...
- **🔧 Agent Issues** — Provide a GitHub issue number and let an autonomous agent analyze the problem, inspect the source code, and propose a patch.
